    ...
    await ApiHelper.get(API.getAllJobs)
      .then((resData) => {
        if (resData) {
          ...
          setJobsList(resData.data.data[2]);
        }
      })
      .catch((err) => {
        console.log(err);
      ...
      <div className="brand-home-main">
        <div className="brand-home-left-container">
          <div className="brand-home-one">
            <div
              className="home-job-add"
              onClick={() => onButtonClick("Button 1", "create-job")}
            >
              <img src={bigAdd} alt="" />
            </div>
            <div className="home-add-title-wrapper">
              ...
              <div className="home-add-description">
                ...
                title should accurately reflect the role and responsibilities of
                the job.
              </div>
            </div>
            <div
              style={{ width: "20%" }}
              onClick={() => onButtonClick("Button 2", "start-now")}
            >
                ...
                <div>
                  {jobsList?.jobImage && (
                    <img
                      ...
                      src={`${API.userFilePath}${jobsList?.jobImage[0]?.fileData}`}
                      alt=""
                    />
                  )}
                </div>
                <div className="campaigns-content-wrapper">
                  <div className="campaign-name">{jobsList?.jobTitle}</div>
                  {jobsList?.jobDescription?.map((htmlContent, index) => (
                    <div
                  ...
                  <div className="campaign-features">
                    <div className="campaign-features-wrapper">
                      ...
                      <div>
                        <div className="campaign-features-title">Followers</div>
                        <div className="campaign-features-count">2000</div>
                      </div>
                    </div>
                    <div className="campaign-features-wrapper">
                      <div className="campaign-icons-wrapper">
                      ...
                      <div>
                        <div className="campaign-features-title">Age</div>
                    ...
                    <div className="campaign-features-wrapper">
                      ...
                      <div>
                        <div className="campaign-features-title">Gender</div>
                        <div className="campaign-features-count">
                          {jobsList?.gender}
                        </div>
                      </div>
                    ...
                    <div className="campaign-features-wrapper">
                      ...
                      <div>
                        <div className="campaign-features-title">Location</div>
                        <div className="campaign-features-count">Australia</div>
                      </div>
                    </div>
                  </div>
                </div>
                <div className="campaign-status">
                  <div className="campaign-features-count">Paid</div>
                </div>
              </div>
              <div className="campaigns-wrapper-two">
                <div className="campaign-company">
                  ...
                  <div className="view-campaign">
                    ...
                    <div className="view-campaign-text">View Campaign</div>
                  </div>
                </div>
              </div>
            </div>
