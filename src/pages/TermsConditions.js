  ...
  return (
    <>
      ...
      <div class="terms-container">
        <p class="terms-updated-date">Updated: 12 May 2024</p>
        <p class="terms-intro">
        ...
        <h2 class="terms-heading">1. Acceptance of Terms</h2>
        ...
        <h2 class="terms-heading">2. User Accounts</h2>
        <p class="terms-paragraph">
        ...
        <h2 class="terms-heading">3. User Responsibilities</h2>
        <p class="terms-paragraph">
        ...
        <h2 class="terms-heading">4. Intellectual Property</h2>
        <p class="terms-paragraph">
        ...
        <h2 class="terms-heading">5. Payments</h2>
        <p class="terms-paragraph">
        ...
        <h2 class="terms-heading">6. Privacy</h2>
        <p class="terms-paragraph">
        ...
        <h2 class="terms-heading">7. Community Guidelines</h2>
        <p class="terms-paragraph">
        ...
        <h2 class="terms-heading">8. Termination</h2>
        <p class="terms-paragraph">
        ...
        <h2 class="terms-heading">9. Modifications</h2>
        <p class="terms-paragraph">
        ...
        <h2 class="terms-heading">10. Limitation of Liability</h2>
        <p class="terms-paragraph">
        ...
        <h2 class="terms-heading">11. Governing Law</h2>
        <p class="terms-paragraph">
        ...
        <h2 class="terms-heading">12. Dispute Resolution</h2>
        <p class="terms-paragraph">
