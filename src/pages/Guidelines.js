  ...
  return (
    <>
      ...
      <div className="bt-container">
        ...
        <h2 className="bt-heading">1. Respect and Professionalism</h2>
        <p className="bt-paragraph">
        ...
        <h2 className="bt-heading">2. Authenticity and Transparency</h2>
        <p className="bt-paragraph">
        ...
        <h2 className="bt-heading">3. Intellectual Property</h2>
        <p className="bt-paragraph">
        ...
        <h2 className="bt-heading">4. Compliance with Laws and Regulations</h2>
        <p className="bt-paragraph">
        ...
        <h2 className="bt-heading">5. Professional Conduct</h2>
        <p className="bt-paragraph">
        ...
        <h2 className="bt-heading">6. Reporting Violations</h2>
        <p className="bt-paragraph">
        ...
        <h2 className="bt-heading">7. Conclusion</h2>
        <p className="bt-paragraph">
